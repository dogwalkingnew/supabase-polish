-- Correct the notification payload for the deployed notifications schema.
-- The table has no metadata column; context remains available from the link and the application record.
