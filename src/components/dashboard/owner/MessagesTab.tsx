...
const MessagesTab = () => {
  ...
  const formatTime = (d: string | null) => { if (!d) return ''; const date = new Date(d); const diff = Date.now() - date.getTime(); return diff < 86400000 ? date.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' }) : date.toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' }); };
