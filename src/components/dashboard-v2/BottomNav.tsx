import { Home, Heart, MessageCircle, User, Briefcase, Euro, Search, Wallet } from "lucide-react";
...
const BottomNav = ({ role, activeMission }: BottomNavProps) => {
  ...
  // 6 items owner: Accueil · Recherche · [GO] · Wallet · Messages · Profil
  const ownerItems = [
    { icon: Home, label: "Accueil", path: basePath },
    { icon: Search, label: "Recherche", path: `${basePath}?tab=recherche` },
    { icon: Wallet, label: "Wallet", path: `${basePath}?tab=portefeuille` },
  ...
  // 6 items walker: Accueil · Missions · [GO] · Libres · Revenus · Profil
  const walkerItems = [
    { icon: Home, label: "Accueil", path: basePath },
    { icon: Briefcase, label: "Missions", path: `${basePath}?tab=missions` },
    { icon: Search, label: "Libres", path: `${basePath}?tab=libres` },
