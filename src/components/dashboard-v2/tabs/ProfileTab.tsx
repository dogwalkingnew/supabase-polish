                ...
                <div className="p-4 space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between text-[10px] font-bold">
                      <span className="text-muted-foreground">Tarif Horaire (87% pour vous)</span>
                    ...
                    <p className="text-[9px] text-muted-foreground">Commission DogWalking : 13% (Paiement Sécurisé inclus)</p>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between text-[10px] font-bold">
