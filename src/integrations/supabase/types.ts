...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      bookings: {
        Row: {
          ...
          funds_release_method: string | null
          funds_released_at: string | null
          id: string
          key_handover_details: string | null
          key_handover_protocol:
            | Database["public"]["Enums"]["key_handover_protocol_type"]
            | null
          key_handover_returned_at: string | null
          ...
          validation_code_used_at: string | null
      ...
      reviews: {
        Row: {
          ...
          id: string
          rating: number
          review_type: Database["public"]["Enums"]["review_type_enum"] | null
          reviewed_id: string
          reviewer_id: string
        }
        Insert: {
    ...
    Functions: {
      ...
      refresh_trust_scores: { Args: never; Returns: number }
      trigger_sos_release: {
    ...
    Enums: {
      ...
      key_handover_protocol_type:
        | "in_person"
        | "lockbox"
        | "neighbor"
        | "already_provided"
      review_type_enum: "owner_to_walker" | "walker_to_owner"
