...
const ServicePage = () => {
  ...
  const serviceFaq = [
    { question: "Comment organiser cette demande ?", answer: "Renseignez le besoin de votre animal, la ville ou zone, puis consultez les profils et confirmez les modalités avec l’Accompagnateur." },
    { question: "Comment confirmer le prix et la durée ?", answer: "Les informations indiquées sur un profil sont données à titre indicatif lorsqu’elles sont renseignées. Le prix, la durée et les conditions doivent être confirmés avant la mission." },
    { question: "Puis-je payer dans DogWalking ?", answer: "Le traitement de paiement en ligne n’est pas encore disponible dans DogWalking. L’application ne bloque pas de fonds, ne facture pas de commission et ne gère pas de remboursement automatisé." },
  ];
            ...
            >
              ...
              >
                ...
                <Badge className="bg-accent/15 text-accent border-0 text-base py-2 px-4 backdrop-blur-sm">
                  <MessageCircle className="h-4 w-4 mr-2" />Modalités à confirmer
                </Badge>
                <Badge className="bg-emerald-500/15 text-emerald-600 border-0 text-base py-2 px-4 backdrop-blur-sm">
                  <Shield className="h-4 w-4 mr-2" />Informations renseignées
                </Badge>
              </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-6 mt-10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-foreground">Profils</div>
                      <div className="text-sm">à consulter selon votre zone</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-foreground">Services</div>
                      <div className="text-sm">et disponibilités renseignés</div>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section className="py-24 px-4">
          <div className="container mx-auto">
            <SectionHeader 
              ...
              subtitle="Les informations utiles à préciser avant la mission"
              icon={Shield}
              iconVariant="primary"
            />
            ...
            <AnimatedGrid className="grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16" staggerDelay={0.1}>
              {[
                { title: "Besoins de l’animal", description: "Précisez les habitudes, contraintes et informations utiles avant l’échange." },
                { title: "Ville ou zone", description: "Renseignez une zone générale et confirmez les détails nécessaires avec l’Accompagnateur." },
                { title: "Durée et créneau", description: "Indiquez vos préférences puis convenez du créneau final avant la mission." },
                { title: "Modalités", description: "Confirmez le prix et les conditions directement avec la personne concernée." },
              ].map((benefit, i) => (
        ...
        <section className="py-24 px-4 bg-muted/30">
          <div className="container mx-auto max-w-5xl">
            <SectionHeader 
              ...
              subtitle="Une demande en quatre étapes simples"
              icon={Zap}
              iconVariant="accent"
            />
            ...
            <div className="relative mt-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
                {[
                  { title: "Recherchez", desc: "Consultez les profils et services renseignés", icon: Search },
                  { title: "Décrivez", desc: "Précisez les besoins de votre animal", icon: Camera },
                  { title: "Échangez", desc: "Confirmez le créneau et les conditions", icon: MessageCircle },
                  { title: "Organisez", desc: "Suivez les informations de votre demande", icon: CheckCircle2 }
                ].map((step, i) => (
                  <motion.div 
                    key={i} 
            ...
            >
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <p className="text-xl opacity-90 mb-10 leading-relaxed">
                  Consultez les profils disponibles et préparez une demande adaptée aux besoins de votre compagnon.
                </p>
