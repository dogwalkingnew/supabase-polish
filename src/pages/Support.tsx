      ...
      <main className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          ...
          <Tabs value={mainTab} onValueChange={setMainTab} className="w-full">
            ...
            <TabsContent value="contact"><div className="max-w-2xl mx-auto"><Card className="border shadow-lg rounded-3xl"><CardContent className="p-7 md:p-10 text-center"><Mail className="w-9 h-9 text-primary mx-auto mb-4" /><h2 className="text-2xl font-bold mb-3">Canal de contact en cours de confirmation</h2><p className="text-muted-foreground mb-4">Aucune adresse de support de production n’est encore publiée. Les coordonnées de l’éditeur et le canal d’exercice des droits seront ajoutés aux ressources légales avant la publication.</p><p className="text-xs text-muted-foreground">N’envoyez pas de données sensibles, de coordonnées complètes ou de documents d’identité par un canal non vérifié.</p></CardContent></Card></div></TabsContent>
          </Tabs>
        </div>
      </main>
      <Footer />
