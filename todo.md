...
- [ ] **Incident bloquant Lovable/mobile — 27 août 2026 :** les routes autres que l’accueil affichent « Impossible d’afficher cette page » sur `kle-polish.lovable.app`. Le 27 août 2026, l’URL Lovable visible dans la capture retourne désormais « Project not found » et ne permet pas de reproduire la page signalée. Dans l’aperçu restauré, l’accès direct à `/walkers` apparaît d’abord sur un chargeur, puis la route complète s’affiche. Identifier la cause du défaut sur l’URL Lovable exacte et réduire l’état de chargement initial, puis valider les rechargements directs mobile avant toute nouvelle déclaration de mise en production.
- [x] **Correction de routage 012 :** activer le mode SPA TanStack Start, publier le shell `_shell.html` et sa réécriture, empêcher l’initialisation Supabase pendant le seul pré-rendu sans navigateur, puis vérifier dans un navigateur les rechargements directs de routes publiques, de service et protégées sur l’artefact de production local.
