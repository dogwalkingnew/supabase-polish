...
- [x] **Correction de routage 012 :** activer le mode SPA TanStack Start, publier le shell `_shell.html` et sa réécriture, puis vérifier dans un navigateur les rechargements directs de routes publiques, de service et protégées sur l’artefact de production local.
